# @diotoborg/ratione-ducimus-porro

![CI](https://github.com/diotoborg/ratione-ducimus-porro/workflows/CI/badge.svg)
[![NPM version](https://img.shields.io/npm/v/@diotoborg/ratione-ducimus-porro.svg?style=flat)](https://www.npmjs.com/package/@diotoborg/ratione-ducimus-porro)
...
## Install
```
npm i @diotoborg/ratione-ducimus-porro
```
...
async function build () {
  ...
  await fastify.register(require('@diotoborg/ratione-ducimus-porro'))
...
You can register an entire Express application and make it work with Fastify. Remember, `@diotoborg/ratione-ducimus-porro` is just `express` under the covers and requires the same body parsers as you'd use in `express`.
...
fastify.register(require('@diotoborg/ratione-ducimus-porro'))
  .after(() => {
...
fastify
  .register(require('@diotoborg/ratione-ducimus-porro'))
  .register(subsystem)
...
You will need to add `"types": ["@diotoborg/ratione-ducimus-porro"]` to your tsconfig.json file when using `require` to import the plugin.
...
const Fastify = require('fastify')
const Express = require('express')
const expressPlugin = require('@diotoborg/ratione-ducimus-porro')
...
For this case, you need to remove `body-parser`, install `@fastify/formbody` and change `@diotoborg/ratione-ducimus-porro` options:
